...
class FabricTarget(Mo):
    ...
    prop._addConstant("fabricFIfPol", "fabric-link-level-policy-(fabric.fifpol)", 17699)
    prop._addConstant("fabricFLinkFlapPol", "fabric-link-flap-policy-(fabric.flinkflappol)", 18263)
    prop._addConstant("fabricFailedDecommissionNode", "the-node-is-unreachable-during-decommission-(fabric.faileddecommissionnode)", 18235)
    ...
    prop._addConstant("fabricLinkFlapPol", "link-flap-policy-(fabric.linkflappol)", 16918)
    ...
    prop._addConstant("fabricRsFIfPol", "relation-to-fabric-interface-policy-(fabric.rsfifpol)", 17700)
    prop._addConstant("fabricRsFLinkFlapPol", "relation-to-fabric-link-flap-policy-(fabric.rsflinkflappol)", 18264)
    ...
    prop._addConstant("infraRsLinkFlapPol", "relation-to-link-flap-policy-(infra.rslinkflappol)", 16919)
    ...
    prop._addConstant("infraRsResLinkFlapPol", "link-flap-policy-(infra.rsreslinkflappol)", 16921)
